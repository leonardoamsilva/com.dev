...
export const Terms = () => {
  return (
     <article>
        ...
        <section>
            <h2>Contato</h2>
            <p>Se você tiver dúvidas sobre estes Termos de Uso ou sobre o <strong>comandos.dev</strong>, entre em contato conosco através do seguinte endereço de e-mail: <a href="mailto:contato@comandos.dev">contato@comandos.dev</a>.</p>
        </section>
