export const About = () => {
  return(
    ...
    <h1>sobre</h1>
        ...
        <p>É possível que você perceba a ausência de algum comando ou até mesmo de algum sistema que utiliza. Nosso
          intuito é armazenar o maior número possível de informações para tornar a jornada dos desenvolvedores
          iniciantes
          mais fácil, evitando que se percam em excesso de dados desnecessários e confusos. A proposta é oferecer
